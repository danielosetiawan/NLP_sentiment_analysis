...
tweets_df = pd.read_csv('/Users/setone/Documents/Projects/NLP_app/data/final_stock_tweets_summary.csv', parse_dates=['Date'])
topics_stats = pd.read_csv('/Users/setone/Documents/Projects/NLP_app/data/final_sent_topic_stats_summary.csv', index_col='Type')
topics_df = pd.read_csv('/Users/setone/Documents/Projects/NLP_app/data/final_sent_topic_chart_summary.csv')
wordcloud_df = pd.read_csv('/Users/setone/Documents/Projects/NLP_app/data/final_wordcloud_summary.csv', index_col='words')
